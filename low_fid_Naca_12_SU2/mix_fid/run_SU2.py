...
confFile = "turb_naca0012.cfg"
new_confFile = "new_turb_naca0012.cfg"
FlowDriver = pysu2.CSinglezoneDriver(confFile, 1, comm)
FlowMarkerID = None
FlowMarkerName = "airfoil"                                             # FSI marker (flow side)
...
BC_MarkerName_Id = FlowMarkerIDs["farfield"]
print(FlowDriver.GetAllInletMarkersTag())
...
def SolveSolutionStep(info):
    ...
    #     var.L_in_N = FlowDriver.Get_LiftCoeff() * var.B_in_cm * var.C_in_cm
